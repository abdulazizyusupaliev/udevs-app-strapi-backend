...
export interface ApiAdminAdmin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    avatar: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    publishedAt: Schema.Attribute.DateTime;
    savedPosts: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    admin: Schema.Attribute.Relation<'manyToOne', 'api::admin.admin'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    time: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'00:00'>;
